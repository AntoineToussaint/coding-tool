"""Canonical solution for c09_remove_sweep / large."""
...
def apply(workdir: Path) -> None:
    inventory_py = workdir / "ecom" / "inventory.py"
    if inventory_py.exists():
        inventory_py.unlink()

    test_inventory_py = workdir / "tests" / "test_inventory.py"
    if test_inventory_py.exists():
        test_inventory_py.unlink()
