"""Canonical solution for c04_signature_change / medium."""
...
def compute_total(order: Order, include_shipping: bool = True) -> float:
...
def estimate_savings(order: Order) -> float:
    ...
    return round(no_disc - compute_total(order, include_shipping=False), 2)
'''
