...
Intentionally under-annotated: most function signatures are missing
...
def _is_billable(order):
    return order.status != "cancelled"


def daily_sales(orders, on_date):
    matching = [
...
def revenue_in_range(orders, start, end):
    if end < start:
